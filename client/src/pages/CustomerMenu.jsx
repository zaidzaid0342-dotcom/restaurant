...
import {
  ...
  FiAlertTriangle,
  FiWifi,
  FiCode, // Icon for Developer Info
  FiUser, // Human logo icon
  FiPhone,
  FiX
} from 'react-icons/fi';
...
/**
 * Developer Info Dialog Component
 */
const DeveloperInfoDialog = ({ isOpen, onClose }) => {
  // Framer Motion backdrop and dialog variants
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          <motion.div
            className="w-70 max-w-md  bg-white rounded-3xl shadow-2xl p-6 md:p-8 border-4 border-amber-500/50 transform"
            variants={dialogVariants}
            onClick={(e) => e.stopPropagation()} // Prevent closing when clicking inside the dialog
          >
            <div className="flex justify-between items-start mb-6">
              <h2 className="text-2xl font-extrabold text-slate-800 flex items-center">
                {/* <FiCode className="w-6 h-6 mr-2 text-amber-500" /> */}
                Developer Info
              </h2>
              <button
                onClick={onClose}
            ...
            <div className="space-y-4">
              <div className="flex items-center p-3 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  <p className="text-xs text-slate-500">Developer Name</p>
                  <p className="font-semibold text-slate-800">Mohammed Zaid</p>
                </div>
              </div>
              <div className="flex items-center p-3 bg-slate-50 rounded-xl border border-slate-100">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="font-semibold text-slate-800 hover:text-amber-500 transition-colors"
                  >
                    +91 7483052937
                  </a>
                </div>
            ...
            <p className="text-center text-xs text-slate-800 mt-6 mr-3">
              © Town Table. All rights reserved.
            </p>
          </motion.div>
        </motion.div>
      )}
...
export default function CustomerMenu() {
  ...
  // NEW STATE: Control the visibility of the developer dialog
  ...
  // Framer Motion variants for the Floating Action Button (FAB)
  const fabVariants = {
    hidden: { 
      opacity: 0, 
      scale: 0, 
    ...
    visible: {
      ...
      transition: {
        ...
        stiffness: 400,
        damping: 20,
        delay: 1.0 // Appear after initial page load animations
      }
    }
  };
  ...
  return (
    <motion.div
      className="min-h-screen bg-gradient-to-br from-gray-50 to-white relative" // Added 'relative' for FAB positioning
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 sm:py-12">
        ...
        >
          <div
            ...
            style={{ backgroundImage: `url('https://plus.unsplash.com/premium_photo-1670984935550-5ce2e220977a?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MzV8fHJlc3RhdXJhbnR8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&q=60&w=600')` }}
          >
            ...
            <div className="relative z-10 h-full flex flex-col items-center justify-center text-white text-center px-4">
              <div className="flex items-center justify-center mb-3">
                ...
                <h1 className="text-3xl sm:text-5xl md:text-6xl font-extrabold text-white tracking-tight drop-shadow-lg">
                  <span className="text-amber-400">Town</span> Table
                </h1>
              </div>
        ...
        {/* Search, Refresh & Cart Header (Developer Info Button moved to FAB) */}
        <motion.header
        ...
        >
          ...
          <div className="flex gap-3 w-full sm:w-auto justify-end">
            {/* Removed the inline developer button here */}
      ...
      <motion.button
        className="fixed bottom-6 right-6 lg:bottom-10 lg:right-10 w-8 h-8 rounded-full bg-slate-800 text-white shadow-2xl flex items-center justify-center border-4 border-amber-400/70 z-40 transition-all duration-300 hover:bg-slate-700"
      ...
      >
        <FiUser className="w-4 h-4" /> {/* Used FiUser for the "human logo" */}
      </motion.button>
    </motion.div>
  );
}